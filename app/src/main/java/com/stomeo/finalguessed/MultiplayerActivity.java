...
public class MultiplayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(
                MultiplayerActivity.this, LinearLayoutManager.HORIZONTAL, false
        );

        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());

        letrasAdapter = new LetrasAdapter(MultiplayerActivity.this, letrasList);
    ...
    public void checkConds(ImageView hangman, char[] caracteres) {
        if (contfallos == 1) {
            ...
            Intent intent = new Intent(mContext, GameOverMultiplayerActivity.class);
